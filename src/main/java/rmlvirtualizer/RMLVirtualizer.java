...
/**
 * This class wraps the official RML engine. Instead of materialising RDF (as the RML engine does) this class aims at virtualize the RDF, i.e., keep the RDF translation in memory
...
public class RMLVirtualizer {
	 ...
	 * @param mappingContent A RML Mapping, notice that this is the content of the mapping and not the file directory
	 * @param baseIRI The IRI based that will be used, if needed, during the virtualization
	 * @param format The output RDF format to which the data in other formats will be translated
	 ...
	 * @param rmlMapping A RML Mapping, notice that this is the content of the mapping and not the file directory
	 * @param baseIRI The IRI based that will be used, if needed, during the virtualization
	 * @param format The output RDF format to which the data in other formats will be translated
